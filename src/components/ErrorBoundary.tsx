...
const FallbackUI: React.FC<FallbackProps> = ({ error, componentStack, resetError }) => {
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6">
        ...
        <button
          onClick={resetError}
          className="w-full py-2 px-4 bg-primary hover:bg-primary/90 text-white font-medium rounded transition duration-200"
        >
          Try again
        </button>
      </div>
