...
Sentry.init({
  ...
  integrations: [
    ...
    // Remove the consoleLoggingIntegration as it's not exported by @sentry/react
  ],
...
// Log application startup using Sentry.captureMessage instead of logger
Sentry.captureMessage('Application starting', {
  level: 'info',
  extra: { version: import.meta.env.VITE_APP_VERSION || '1.0.0' }
});
